...
import { Activity, Linkedin, BookOpen, HelpCircle } from 'lucide-react';
        ...
        <header className="h-[44px] bg-slate-900/50 backdrop-blur-sm border-b border-slate-800/80 flex items-center justify-between px-4 z-50">
            ...
            <div className="flex items-center gap-2 md:gap-4">
                <div className="flex items-center gap-2 text-blue-500">
                    <Activity size={20} />
                    <span className="font-bold text-lg tracking-tight text-slate-100 hidden sm:inline">StructLab</span>
                </div>
                ...
                <div className="flex bg-slate-800/50 rounded-lg p-1 max-w-[160px] sm:max-w-none">
                    ...
                    >
                        <span className="hidden sm:inline">Beam Analysis</span>
                    ...
                    >
                        <span className="hidden sm:inline">Truss Analysis</span>
            ...
            <div className="flex items-center gap-1 sm:gap-3">
                <IconButton icon={<Linkedin size={16} />} href="https://www.linkedin.com/in/suuleymankaya0/" label="LinkedIn" />
                <IconButton icon={<BookOpen size={16} />} label="Docs" onClick={onShowDocs} />
                <div className="hidden sm:block w-px h-4 bg-slate-700 mx-1"></div>
                <div className="hidden sm:block">
                    <IconButton icon={<HelpCircle size={16} />} label="Help" onClick={onShowHelp} />
                </div>
            </div>
        </header>
    );
